...
class UserServiceTest {
    ...
    private lateinit var transormApi: TransformApi
    ...
    fun setUp() {
        ...
        emailApi = mock(EmailApi::class.java)
        ...
        shareApi = mock(ShareApi::class.java)
        transormApi = mock(TransformApi::class.java)
        subscriptionApi = mock(SubscriptionApi::class.java)
